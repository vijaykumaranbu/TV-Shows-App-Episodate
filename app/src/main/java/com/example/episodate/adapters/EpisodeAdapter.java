...
import com.example.episodate.databinding.ItemContainerEpisodeBinding;
...
public class EpisodeAdapter extends RecyclerView.Adapter<EpisodeAdapter.EpisodeViewHolder>{
    ...
    public EpisodeViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        ItemContainerEpisodeBinding itemContainerEpisodeBinding = DataBindingUtil
                .inflate(layoutInflater, R.layout.item_container_episode,parent,false);
